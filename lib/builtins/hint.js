...
module.exports = function(att){
  ...
  att.register('hint', 'code syntax validation', function(){
    ...
    **/
    this.help = function(){
      var str = ['Options:',
        ...
        ' --node      是否是node环境',
        ' --phantom   是否是phantom环境',
        ' --yui       是否是YUI环境',
        '',
        'Examples:',
        ' att hint att.js --node',
        '',
        ' #检查css',
        ' att hint my.css',
        '',
    ...
    **/
    this.hintFile = function(input, callback, options){
      ...
      if(argv.phantom !== undefined){
        opts.phantom = argv.phantom;
      }
      if(argv.typed !== undefined){
        opts.typed = argv.typed;
      }
      if(argv.yui !== undefined){
        opts.yui = argv.yui;
      }
     if(argv.couch !== undefined){
        opts.couch = argv.couch;
      }
      if(ext == 'js'){
